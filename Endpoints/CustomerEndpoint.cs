...
{
    public static class CustomerEndponit
    {
        ...
        public static void AddCustomerEndpoints(this WebApplication app)
        {
            ...
            app.MapPost("/customer/search", async (SearchQueryCustomerDTO customerDTO, CustomersDAL customerDAL) =>
            {
            ...
            app.MapGet("/customer/{id}", async (int id, CustomersDAL customerDAL) =>
            {
            ...
            app.MapPost("/customer", async (CreateCustomerDTO customerDTO, CustomersDAL customerDAL) =>
            {
                //Crear un objeto 'Customer' a partir de los datos proporcionados 
                var customer = new Customer
                {
            ...
            //Configurar un endpoint de tipo PUT para editar un cliente eistente
            app.MapPut("/customer", async (EditCustomerDTO customerDTO, CustomersDAL customerDAL) =>
            {
                //Crear un objeto 'Customer' a partir de los datos proporcionados
                var customer = new Customer
                {
            ...
            //Configurar en endpoint de tipo DELETE para eliminar un cliente por ID
            app.MapDelete("/customer/{id}", async (int id, CustomersDAL customerDAL) =>
            {
                //Intentar eliminar el cliente y devolver el resutado correspondiente
